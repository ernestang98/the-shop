...
public class Measurements : MonoBehaviour {
	 ...
	 *									Settings
	 * *********************************************************************************/
   // public Text facewidth;
   // public Text facelength;
   // public Text facedepth;
	...
	void runCalculations()
	{
       ...
       // facewidth.text = width_string;
       // facelength.text = height_string;
       // facedepth.text = depth_string;
       Text w = GameObject.Find("Canvas/width").GetComponent<Text>();
        Text l = GameObject.Find("Canvas/length").GetComponent<Text>();
        Text d = GameObject.Find("Canvas/depth").GetComponent<Text>();
        w.text = width_string;
        l.text = height_string;
        d.text = depth_string;
