...
public class ScreenRecorder : MonoBehaviour
{
    ...
    [HideInInspector] public Texture2D screenShot;
    ...
    void DisableScreenShotSnap()
    {
        screenShotSnap.gameObject.transform.parent.gameObject.SetActive(false);
    }
    ...
    void Update()
    {
        ...
        if (captureScreenshot || captureVideo)
        {
            ...
            else if (format == Format.JPG)
            {
                ...
                LoadImages(fileData, screenShotSnap);
                screenShotSnap.gameObject.transform.parent.gameObject.SetActive(true);
                Invoke("DisableScreenShotSnap", 3f);
                NativeGallery.SaveImageToGallery(fileData, "ARFurniture", filename, null);
                //FM.UploadImage(fileData);
            }
            else // ppm
            {
